  ...
  return (
    <footer className="relative">
      <div className="w-full h-fit pt-[170px] pb-[40px] max-w-[1850px] mx-auto relative z-1">
        ...
        <h3 className="w-fit mx-auto mb-[100px] title-footer text-center text-light-cyan filter-five-blue">
          Сервер, контент и эта презентация — плод труда команды MCSkill.
          <br />
          Спасибо, что играете с нами. Мы ценим каждого из вас!
        </h3>
        <div className="h-[100px] gradient-border2 bg-fadecyan border-[5px] mb-[20px]">
          <ul className="row_links w-full px-[100px] flex justify-between h-full items-center gap-[50px] mx-auto title4 text-cyan">
            <li>
            ...
            <li>
              <Link href="https://mcskill.net/static/contacts" className="link">
                Контакты
              </Link>
            </li>
          </ul>
