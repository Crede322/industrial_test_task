  ...
  return (
    <header className="w-full backdrop-blur-lg sticky top-0 z-20">
      <div className="relative">
        <div className="absolute bg-fadecyan top-0 left-0 right-0 h-[100px]">
          <div className="max-w-[1920px] mx-auto h-[100px] flex items-center">
            ...
            <ul
              className={cn(
                ...
                "row_links absolute px-[2vw] flex-col min-[1400px]:flex-row items-end min-[1400px]:items-center justify-between min-[1400px]:justify-end min-[1660px]:justify-center top-[100%] min-[1400px]:static w-full flex h-full gap-x-[10px] min-[1400px]:gap-[50px] mx-auto title4 text-cyan overflow-hidden"
              )}
            >
              <li>
